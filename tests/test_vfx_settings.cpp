...
int test_vfx_settings() {
  ...
  s.proceduralSky.starSize = 1.35f;
  s.proceduralSky.starTwinkle = 0.42f;
  s.proceduralSky.starClusterStrength = 0.85f;
  s.proceduralSky.starClusterFrequency = 1.75f;
  s.proceduralSky.starSpikeStrength = 0.45f;
  s.proceduralSky.milkyWayEnabled = false;
  s.proceduralSky.milkyWayIntensity = 1.3f;
  s.proceduralSky.milkyWayFrequency = 2.1f;
  s.proceduralSky.milkyWayBandPower = 2.9f;
  s.proceduralSky.milkyWayDust = 0.66f;
  ...
  CHECK(feqf(out.proceduralSky.starSize, s.proceduralSky.starSize));
  CHECK(feqf(out.proceduralSky.starTwinkle, s.proceduralSky.starTwinkle));
  CHECK(feqf(out.proceduralSky.starClusterStrength, s.proceduralSky.starClusterStrength));
  CHECK(feqf(out.proceduralSky.starClusterFrequency, s.proceduralSky.starClusterFrequency));
  CHECK(feqf(out.proceduralSky.starSpikeStrength, s.proceduralSky.starSpikeStrength));
  CHECK(out.proceduralSky.milkyWayEnabled == s.proceduralSky.milkyWayEnabled);
  CHECK(feqf(out.proceduralSky.milkyWayIntensity, s.proceduralSky.milkyWayIntensity));
  CHECK(feqf(out.proceduralSky.milkyWayFrequency, s.proceduralSky.milkyWayFrequency));
  CHECK(feqf(out.proceduralSky.milkyWayBandPower, s.proceduralSky.milkyWayBandPower));
  CHECK(feqf(out.proceduralSky.milkyWayDust, s.proceduralSky.milkyWayDust));
